...
import org.apache.ranger.services.prestodb.client.PrestodbResourceManager;
...
public class RangerServicePrestodb extends RangerBaseService {
  ...
  public List<RangerPolicy> getDefaultRangerPolicies() throws Exception {
    if (LOG.isDebugEnabled()) {
      LOG.debug("==> RangerServicePrestodb.getDefaultRangerPolicies()");
    }
  ...
  public Map<String, Object> validateConfig() throws Exception {
    ...
    if (configs != null) {
      try {
        ...
        ret = PrestodbResourceManager.connectionTest(serviceName, configs);
  ...
  public List<String> lookupResource(ResourceLookupContext context) throws Exception {
    ...
    if(LOG.isDebugEnabled()) {
      LOG.debug("==> RangerServicePrestodb.lookupResource() Context: (" + context + ")");
    }
    if (context != null) {
      try {
        if (!configs.containsKey(HadoopConfigHolder.RANGER_LOGIN_PASSWORD)) {
        ...
        ret  = PrestodbResourceManager.getPrestodbResources(serviceName, serviceType, configs,context);
      } catch (Exception e) {
